    ...
    return(
        ...
        <div class = "home_about">
            ...
            <div class = "home_about_text">
                <div>
                    <p>My name is Lawrence Carroll, I am a software developer, an artist, and an organizer. <nl/>I am currently looking for any oppurtunity to allow myself to earn money as a programmer, so that I can sharpen my skills as I earn a living.</p>            
